...
WbFieldRef wb_supervisor_node_get_field_by_index(WbNodeRef node,
                                                 const int index);
...
// use wb_supervisor_node_enable_contact_points_tracking or
// wb_supervisor_node_disable_contact_points_tracking instead
void wb_supervisor_node_enable_contact_point_tracking(WbNodeRef node,
                                                      int sampling_period,
                                                      bool include_descendants);
...
void wb_supervisor_simulation_revert()
    WB_DEPRECATED; // please use wb_supervisor_world_reload() instead
void wb_supervisor_load_world(const char *filename)
    WB_DEPRECATED; // please use wb_supervisor_world_load() instead
bool wb_supervisor_save_world(const char *filename)
    WB_DEPRECATED; // please use wb_supervisor_world_save() instead

// deprecated since Webots 8.6.0, plesae use
// wb_supervisor_field_remove_mf_item() instead
void wb_supervisor_field_remove_mf_node(WbFieldRef field,
                                        int position) WB_DEPRECATED;

// deprecated since Webots 8.0.0, plesae use
// wb_supervisor_simulation_reset_physics() instead
void wb_supervisor_simulation_physics_reset() WB_DEPRECATED;

// deprecated since Webots 8.4.0 please use wb_supervisor_movie_is_ready and
...
// deprecated since webots 8.3.0: please use the wb_supervisor_movie_*()
// functions instead
