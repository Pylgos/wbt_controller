...
void Motor::setVelocity(double vel) { wb_motor_set_velocity(getTag(), vel); }
...
// Force
void Motor::setForce(double force) { wb_motor_set_force(getTag(), force); }
...
// Torque
void Motor::setTorque(double torque) { wb_motor_set_force(getTag(), torque); }
...
Motor::Type Motor::getType() const { return Type(wb_motor_get_type(getTag())); }
...
double Motor::getVelocity() const { return wb_motor_get_velocity(getTag()); }
...
double Motor::getMaxForce() const { return wb_motor_get_max_force(getTag()); }

double Motor::getAvailableTorque() const {
  return wb_motor_get_available_torque(getTag());
}

double Motor::getMaxTorque() const { return wb_motor_get_max_torque(getTag()); }
...
int Motor::getBrakeTag() const { return wb_motor_get_brake(getTag()); }
