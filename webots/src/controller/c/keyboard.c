...
// Protected constants and funtions available from other files of the client
// library

const int wb_KEYBOARD_END = WB_KEYBOARD_END,
          wb_KEYBOARD_HOME = WB_KEYBOARD_HOME,
          wb_KEYBOARD_LEFT = WB_KEYBOARD_LEFT, wb_KEYBOARD_UP = WB_KEYBOARD_UP,
          wb_KEYBOARD_RIGHT = WB_KEYBOARD_RIGHT,
          wb_KEYBOARD_DOWN = WB_KEYBOARD_DOWN,
          wb_KEYBOARD_PAGEUP = WB_KEYBOARD_PAGEUP,
          wb_KEYBOARD_PAGEDOWN = WB_KEYBOARD_PAGEDOWN,
          wb_KEYBOARD_NUMPAD_HOME = WB_KEYBOARD_NUMPAD_HOME,
          wb_KEYBOARD_NUMPAD_LEFT = WB_KEYBOARD_NUMPAD_LEFT,
          wb_KEYBOARD_NUMPAD_UP = WB_KEYBOARD_NUMPAD_UP,
          wb_KEYBOARD_NUMPAD_RIGHT = WB_KEYBOARD_NUMPAD_RIGHT,
          wb_KEYBOARD_NUMPAD_DOWN = WB_KEYBOARD_NUMPAD_DOWN,
          wb_KEYBOARD_NUMPAD_END = WB_KEYBOARD_NUMPAD_END,
          wb_KEYBOARD_KEY = WB_KEYBOARD_KEY,
          wb_KEYBOARD_SHIFT = WB_KEYBOARD_SHIFT,
          wb_KEYBOARD_CONTROL = WB_KEYBOARD_CONTROL,
